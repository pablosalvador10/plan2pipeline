...
This template contains **18 deterministic files** that together form a
...
This copies all 18 automation files into your new repository.
...
your issue dispatch logic.  The template ships with `developer` and
`qa-reviewer` as the minimum viable set.
